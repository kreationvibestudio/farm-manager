...
-- ⚠️ IMPORTANT: Run supabase-schema.sql FIRST before running this script!
-- This will populate your database with realistic sample data
--
-- If you get an error "relation does not exist", you need to run supabase-schema.sql first
-- to create the tables (staff, vehicles, inventory_items, harvest_logs)
